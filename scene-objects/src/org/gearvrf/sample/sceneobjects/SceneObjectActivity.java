...
//    		mViewManager.onTap();
    		...
    		try {
    			...
    			mViewManager.textViewSceneObject.setText("");
    		} catch (ActivityNotFoundException a) {
    			GVRConsole console = new GVRConsole(mViewManager.myGVRContext, EyeMode.LEFT_EYE);
    			console.writeLine(a.getLocalizedMessage());
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case RESULT_SPEECH: {
			if (resultCode == RESULT_OK && null != data) {
				...
				mViewManager.textViewSceneObject.setText(text.get(0));
			}
			break;
		}
		}
