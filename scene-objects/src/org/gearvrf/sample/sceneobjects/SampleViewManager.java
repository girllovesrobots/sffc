...
public class SampleViewManager extends GVRScript {
    ...
    public GVRContext myGVRContext;
    private int currentObject = 0;
    private SceneObjectActivity mActivity;
    public GVRTextViewSceneObject textViewSceneObject;
...
//        GVRWebViewSceneObject webViewObject = createWebViewObject(gvrContext);
        GVRCameraSceneObject cameraObject = new GVRCameraSceneObject(
                gvrContext, 6.0f, 3.0f, mActivity.getCamera());
//        GVRVideoSceneObject videoObject = createVideoObject(gvrContext);
         textViewSceneObject = new GVRTextViewSceneObject(
...
//        }
        cameraObject.getRenderData().setRenderMask(
...
//        videoObject.getTransform().setPosition(0.0f, 0.0f, -4.0f);
        textViewSceneObject.getTransform().setPosition(1.0f, -1.5f, -1.0f);
        mainCameraRig.getOwnerObject().addChildObject(cameraObject);
        mainCameraRig.getOwnerObject().addChildObject(textViewSceneObject);
